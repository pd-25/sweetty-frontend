                      ...
                      <table className="table table-borderless">
                        ...
                        <tbody>
                          <tr>
                            <th scope="row">
                              <a href="#">
                                <img src="../hotelassets/img/product-1.jpg" alt="" />
                              </a>
                            </th>
                            <td>
                          ...
                          <tr>
                            <th scope="row">
                              <a href="#">
                                <img src="../hotelassets/img/product-2.jpg" alt="" />
                              </a>
                            </th>
                            <td>
                              <a href="#" className="text-primary fw-bold">
                          ...
                          <tr>
                            <th scope="row">
                              <a href="#">
                                <img src="../hotelassets/img/product-3.jpg" alt="" />
                              </a>
                            </th>
                            <td>
                              <a href="#" className="text-primary fw-bold">
                          ...
                          <tr>
                            <th scope="row">
                              <a href="#">
                                <img src="../hotelassets/img/product-4.jpg" alt="" />
                              </a>
                            </th>
                            <td>
                              <a href="#" className="text-primary fw-bold">
                          ...
                          <tr>
                            <th scope="row">
                              <a href="#">
                                <img src="../hotelassets/img/product-5.jpg" alt="" />
                              </a>
                            </th>
                            <td>
                              <a href="#" className="text-primary fw-bold">
                ...
                <div className="card-body pb-0">
                  ...
                  <div className="news">
                    <div className="post-item clearfix">
                      <img src="../hotelassets/img/news-1.jpg" alt="" />
                      <h4>
                    ...
                    <div className="post-item clearfix">
                      <img src="../hotelassets/img/news-2.jpg" alt="" />
                      <h4>
                    ...
                    <div className="post-item clearfix">
                      <img src="../hotelassets/img/news-3.jpg" alt="" />
                      <h4>
                        <a href="#">
                    ...
                    <div className="post-item clearfix">
                      <img src="../hotelassets/img/news-4.jpg" alt="" />
                      <h4>
                    ...
                    <div className="post-item clearfix">
                      <img src="../hotelassets/img/news-5.jpg" alt="" />
                      <h4>
